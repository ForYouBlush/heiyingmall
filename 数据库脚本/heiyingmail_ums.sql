...
MySQL - 5.7.36 : Database - heiyingmail_ums
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`heiyingmail_ums` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `ums_member`(`id`,`level_id`,`username`,`password`,`nickname`,`mobile`,`email`,`header`,`gender`,`birth`,`city`,`job`,`sign`,`source_type`,`integration`,`growth`,`status`,`create_time`) values (1,NULL,'aaa','qwe','qwe',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

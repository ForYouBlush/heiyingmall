...
MySQL - 5.7.36 : Database - heiyingmail_wms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`heiyingmail_wms` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `wms_purchase` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='采购信息';

/*Data for the table `wms_purchase` */

insert  into `wms_purchase`(`id`,`assignee_id`,`assignee_name`,`phone`,`priority`,`status`,`ware_id`,`amount`,`create_time`,`update_time`) values (2,1,'admin','13612345678',2,1,NULL,NULL,'2021-10-27 06:35:13','2021-10-27 06:49:43');
...
insert  into `wms_purchase_detail`(`id`,`purchase_id`,`sku_id`,`sku_num`,`sku_price`,`ware_id`,`status`) values (4,2,4,4,NULL,1,1),(5,2,8,8,NULL,1,1);
...
insert  into `wms_ware_info`(`id`,`name`,`address`,`areacode`) values (1,'1号仓库','江西','335500');

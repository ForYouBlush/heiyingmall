...
MySQL - 5.7.36 : Database - heiyingmail_sms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`heiyingmail_sms` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `sms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='商品会员价格';

/*Data for the table `sms_member_price` */

insert  into `sms_member_price`(`id`,`sku_id`,`member_level_id`,`member_level_name`,`member_price`,`add_other`) values (1,1,2,'铜牌会员','0.0000',1),(2,1,3,'银牌会员','0.0000',1),(3,2,2,'铜牌会员','0.0000',1),(4,2,3,'银牌会员','0.0000',1),(5,3,2,'铜牌会员','0.0000',1),(6,3,3,'银牌会员','0.0000',1),(7,4,2,'铜牌会员','0.0000',1),(8,4,3,'银牌会员','0.0000',1);
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='商品满减信息';

/*Data for the table `sms_sku_full_reduction` */

insert  into `sms_sku_full_reduction`(`id`,`sku_id`,`full_price`,`reduce_price`,`add_other`) values (1,1,'0.0000','0.0000',NULL),(2,2,'0.0000','0.0000',NULL),(3,3,'0.0000','0.0000',NULL),(4,4,'0.0000','0.0000',NULL),(5,5,'5000.0000','50.0000',NULL);
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='商品阶梯价格';

/*Data for the table `sms_sku_ladder` */

insert  into `sms_sku_ladder`(`id`,`sku_id`,`full_count`,`discount`,`price`,`add_other`) values (1,1,0,'0.00',NULL,0),(2,2,0,'0.00',NULL,0),(3,3,0,'0.00',NULL,0),(4,4,0,'0.00',NULL,0),(5,5,10,'0.98',NULL,0);
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='商品spu积分设置';

/*Data for the table `sms_spu_bounds` */

insert  into `sms_spu_bounds`(`id`,`spu_id`,`grow_bounds`,`buy_bounds`,`work`) values (1,5,'0.0000','0.0000',NULL),(2,6,'0.0000','0.0000',NULL),(3,7,'500.0000','200.0000',NULL),(4,11,'500.0000','500.0000',NULL);

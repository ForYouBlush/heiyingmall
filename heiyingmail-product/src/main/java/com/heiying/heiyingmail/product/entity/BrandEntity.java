package com.heiying.heiyingmail.product.entity;
...
import com.heiying.common.valid.ListValue;
...
public class BrandEntity implements Serializable {
    ...
    @Pattern(regexp = "^[a-zA-Z]$", message = "检索首字母必须是一个子母", groups = {AddGroup.class, UpdateGroup.class})
